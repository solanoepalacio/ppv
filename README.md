...
- **Single-collator dev deployment.** Not decentralized in any meaningful sense during Phase 1–2; the "Polkadot-native" story is in the runtime, tooling, and Bulletin + DotNS integration, not the consensus model.
