import { default as ppview, type PpviewWhitelistEntry } from "./ppview";
export { ppview };
export type * from "./ppview";
...
export type WhitelistEntry = PpviewWhitelistEntry | BulletinWhitelistEntry;
export type WhitelistEntriesByChain = Partial<{
    "*": WhitelistEntry[];
    ppview: WhitelistEntry[];
